    ...
    CATEGORY_COLOR_MAP.update(
        {
            ...
            "tools": COLORS["tools_cyan"],
            "system_tools": COLORS["tools_cyan"],
            "browser_general": COLORS["browser_amber"],
            "browser_other": COLORS["browser_amber"],
            "idle": COLORS["idle_gray"],
            "other": COLORS["other_teal"],
        }
    )
